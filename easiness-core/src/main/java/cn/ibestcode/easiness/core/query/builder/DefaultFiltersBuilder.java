package cn.ibestcode.easiness.core.query.builder;
...
public class DefaultFiltersBuilder implements OrFiltersBuilder, AndFiltersBuilder {
  ...
  @Override
  public FiltersBuilder isTrue(String key) {
    assureConditionFiltersIsProcessed();
    filters.add(new DefaultFilter(FilterType.isTrue, key));
    return this;
  }

  @Override
  public FiltersBuilder isFalse(String key) {
    assureConditionFiltersIsProcessed();
    filters.add(new DefaultFilter(FilterType.isFalse, key));
    return this;
  }
  ...
  class DefaultConditionBuilder implements OrConditionBuilder, AndConditionBuilder {
    ...
    @Override
    public ConditionBuilder isTrue(String key) {
      assureConditionFiltersIsNotNull();
      conditionFilters.add(new DefaultFilter(FilterType.isTrue, key));
      return this;
    }

    @Override
    public ConditionBuilder isFalse(String key) {
      assureConditionFiltersIsNotNull();
      conditionFilters.add(new DefaultFilter(FilterType.isFalse, key));
      return this;
    }
