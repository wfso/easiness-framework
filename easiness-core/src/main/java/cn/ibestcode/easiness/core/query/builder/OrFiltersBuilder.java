...
public interface OrFiltersBuilder extends FiltersBuilder {
  ...
  default OrFiltersBuilder orIsTrue(String key) {
    isTrue(key);
    return this;
  }

  default OrFiltersBuilder orIsFalse(String key) {
    isFalse(key);
    return this;
  }
  ...
  interface AndConditionBuilder extends ConditionBuilder {
    ...
    default AndConditionBuilder andIsTrue(String key) {
      isTrue(key);
      return this;
    }

    default AndConditionBuilder andIsFalse(String key) {
      isFalse(key);
      return this;
    }
