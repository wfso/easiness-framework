...
public interface AndFiltersBuilder extends FiltersBuilder {
  ...
  default AndFiltersBuilder andIsTrue(String key) {
    isTrue(key);
    return this;
  }

  default AndFiltersBuilder andIsFalse(String key) {
    isFalse(key);
    return this;
  }
  ...
  interface OrConditionBuilder extends ConditionBuilder {
    ...
    default OrConditionBuilder orIsTrue(String key) {
      isTrue(key);
      return this;
    }

    default OrConditionBuilder orIsFalse(String key) {
      isFalse(key);
      return this;
    }
