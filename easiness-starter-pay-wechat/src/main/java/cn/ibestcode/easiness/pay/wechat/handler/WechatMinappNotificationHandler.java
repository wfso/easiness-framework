...
@Component
@Slf4j
public class WechatMinappNotificationHandler extends WechatNotificationHandler {
  @Autowired
  private WechatMinappProperties properties;

  public WechatMinappProperties getProperties() {
    return properties;
  }

  @Override
  public String supportType() {
    return EasinessPayWechatConstant.EASINESS_PAY_TYPE_MINAPP;
  }
}
