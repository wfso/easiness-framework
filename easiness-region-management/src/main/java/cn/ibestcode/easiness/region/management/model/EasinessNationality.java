...
@Getter
@ApiModel("区、县")
@Table(name = "easiness_region_nationality", indexes = {
  @Index(name = "easiness_region_nationality_code", columnList = "code", unique = true),
  @Index(name = "easiness_region_nationality_level", columnList = "level")
})
@Entity
@ToString(callSuper = true)
public class EasinessNationality extends BaseJpaModel {
