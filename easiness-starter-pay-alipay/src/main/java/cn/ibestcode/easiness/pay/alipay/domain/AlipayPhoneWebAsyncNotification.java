...
/**
 * @author WFSO (仵士杰)
 * create by WFSO (仵士杰) at 2020/2/8 20:29
 */
@Setter
@Getter
@ToString(callSuper = true)
@ApiModel("支付宝手机网站支付异步通知对象")
public class AlipayPhoneWebAsyncNotification extends AlipayAsyncNotification {
  ...
  public AlipayPhoneWebAsyncNotification(Map<String, String> params) {
    super(params);
